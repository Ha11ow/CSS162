    ...
    public class PolyDemoPanel extends JPanel {     
        ...
        public Shape getRandShape() {
            ...
            switch(( int )(Math.random() * 5) ) {
                ...
                break;
                case 1:   retVal = new Circle( x, y, getRandInt());
                break;
                case 2:   retVal = new Spray(x,y);
                break;
                case 3:   retVal = new Moon(x,y,getRandInt(),getRandInt());
                break;
                case 4:   retVal = new PokeBall(x,y,getRandInt());
                break;
		case 5:   retVal = new Rectangle(x,y,getRandInt());
		break;
            }
