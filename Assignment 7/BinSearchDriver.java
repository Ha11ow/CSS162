...
public class BinSearchDriver  {
    ...
    public final static String FILE_AND_PATH = "C:\\Users\\Behnam\\OneDrive\\CSS 143\\Homeworks\\HomeWork 7\\longwords.txt";
    /* 
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        tryLinearSearch(wordsToSearch, "AFFLICTIVELY");
        ...
        tryBinarySearch(wordsToSearch, "AFFLICTIVELY");
    ...
    private static void tryBinarySearch(String[] wordsToSearch, String target) {
        ...
        try {
            System.out.print( target + " found at index using binarySearch: " + bs.recSearch(wordsToSearch,target));
    ...
    private static void tryLinearSearch(String[] wordsToSearch, String target) {
        ...
        try {
            System.out.print( target + " found at index using LinearSearch: " + bs.recSearch(wordsToSearch,target));
            System.out.println( " taking " + bs.getCount() + " comparisons.");
