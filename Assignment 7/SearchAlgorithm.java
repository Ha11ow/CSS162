...
public abstract class SearchAlgorithm {
     ...
     * 
     */
    public abstract int search(String[] words, String target) throws ItemNotFoundException;

    public abstract int recSearch(String[] words, String target) throws ItemNotFoundException;
